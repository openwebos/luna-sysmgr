...
#include "../../Src/lunaui/launcher/elements/static/picturebox.h"
...
static const char qt_meta_stringdata_PictureBox[] = {
    "PictureBox\0"
};
...
const QMetaObjectExtraData PictureBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PictureBox::staticMetaObject = {
    { &ThingPaintable::staticMetaObject, qt_meta_stringdata_PictureBox,
      qt_meta_data_PictureBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PictureBox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PictureBox))
        return static_cast<void*>(const_cast< PictureBox*>(this));
    if (!strcmp(_clname, "com.trolltech.Qt.QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< PictureBox*>(this));
