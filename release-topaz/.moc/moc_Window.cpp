...
const QMetaObject Window::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_Window,
...
int Window::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = mouseGrabbed(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setMouseGrabbed(*reinterpret_cast< bool*>(_v)); break;
        }
        _id -= 1;
